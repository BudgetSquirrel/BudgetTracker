...
namespace BudgetTracker.Web.Migrations
{
    ...
    [Migration("20190727222947_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetTracker.Web.Data.Models.BudgetDurationModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BudgetTracker.Web.Data.Models.BudgetModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BudgetTracker.Web.Data.Models.BudgetModel", b =>
                {
                    b.HasOne("BudgetTracker.Web.Data.Models.BudgetDurationModel", "Duration")
                        .WithMany("Budgets")
                        .HasForeignKey("DurationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BudgetTracker.Web.Data.Models.UserModel", "Owner")
                        .WithMany("Budgets")
